...
<div class="container-fluid">
    <div class="container-fluid bg-dark">
        <div class="row" style="padding-bottom:10px">
            ...
            <div class=" col-md-1.5 col-xs-4" style="padding: 10px;">
                <button type="button" class="btn  btn-rounded btn-outline-primary active" onclick="location.href='newreleases.html'">New Releases</button>
            </div>
            <div class=" col-md-1.5 col-xs-4" style="padding: 10px;">
      ...
      <div class=" col-md-1.5 col-xs-4" style="padding: 10px;">
        ...
        try{
             ...
             con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","skybeats","skybeats");
                  PreparedStatement psmt=con.prepareStatement("select * from (select * from album order by releasedate desc) where rownum <=30");
                  ...
                  while(rs.next())
                  {
                      ...
                      String link="album_page.jsp?albumid="+albumid+"";
                      %>
                     
                       <div class="col-md-3">
              <img src="download.jsp?albumid=<%=albumid%>" onclick="location.href='<%=link %>'"  id="icon" style="cursor:pointer; padding:10px;" alt="">
            </div>
                      <% 
                  }
                  con.close();
